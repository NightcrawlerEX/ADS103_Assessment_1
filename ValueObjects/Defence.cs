...
/// 
/// Defence is part of the damage calculation
/// Damage = Enemy Strength - Defence
/// </summary>
internal class Defence
{
    ...
    {
        if (_value < 1) throw new Exception("Defence must be larger than zero");
        if (_value > 100) throw new Exception("Cannot have more than 100 Defence");
    }//end valudate
