...
/// 
/// Mana points are used by the Paladin class. They are the "Energy" used for its special move
/// </summary>
internal class ManaPoints
{
    private int _value;
    ...
    {
        if (_value < 1) throw new Exception("ManaPoints must be larger than zero");
        if (_value > 100) throw new Exception("Cannot have more than 100 ManaPoints");
    }//end valudate
